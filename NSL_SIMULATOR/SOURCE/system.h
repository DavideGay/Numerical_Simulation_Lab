...
private:
  ...
  bool _tails;          // Flag indicating whether to compute tail corrections
  bool _equilibrated;   // Flag indicating whether to output final values; used for ising type simulations
...
public: // Function declarations
  ...
  void measure_outputs(int blk);  // Prints final averages along with simulation temperature (if simtype==Ising)
